...
To fetch the Brigade ACR Gateway chart from the registry:

```console
  export HELM_EXPERIMENTAL_OCI=1
  helm chart pull ghcr.io/brigadecore/brigade-acr-gateway:v0.1.0
  helm chart export ghcr.io/brigadecore/brigade-acr-gateway:v0.1.0 -d ~/charts
```
...
```console
$ helm inspect values ~/charts/brigade-acr-gateway > my-values.yaml
```
...
```console
$ helm install brigade-acr-gateway ~/charts/brigade-acr-gateway \
    --create-namespace \
